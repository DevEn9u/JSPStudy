...
Map Collection을 생성한다. 파라미터가 추가되는 경우에도 그대로 활용할 수 있다.
*/
...
1page로 지정한다. 만약 파라미터 pageNum이 있다면 request 내장 객체를 통해
받아온 후 페이지번호로 지정하면 된다.
*/
int pageNum = 1;
...
<body>
	...
	<table border="1" width="90%">
		...
		<%
		// isEmpty(): List에 출력할 데이터가 없는지 확인하는 메서드 
		...
		<%
			...
			// 출력할 데이터가 있다면 확장for문으로 반복해서 출력한다.
			int virtualNum = 0;
			int countNum = 0;
