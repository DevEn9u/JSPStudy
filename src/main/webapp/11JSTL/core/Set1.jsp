...
구 태그들의 호환성을 위해 남겨져 있는 상태.
24년 7월 현재까지 사용하는 데에는 문제 없으나 후에 없어질 수 있다. -->
<%--@ taglib prefix="c"  uri="http://java.sun.com/jsp/jstl/core" --%>

<!-- JSTL 최신 버전에서 사용하는 지시어. jakarta로 시작되는 패키지명을 사용한다. -->
...
-->
	...
	double quotation이 겹쳐지는 경우가 발생하게 된다. 이때 value를
	single quotation으로 감싸서 겹쳐지지 않게 처리해야 한다.
	 -->
	...
	자바빈의 getter()를 통해 멤버변수의 값이 출력된다. 
	 -->
	<ul>
		<!-- 겹치는 속성명이 없기때문에 'requestScope'는 사실 생략해도 된다. -->
