...
public class BoardDAO extends JDBConnect {
	...
	/*
	 생성자 호출시 application 내장 객체를 매개변수로 받은 후
	...
	public List<BoardDTO> selectList(Map<String, Object> map) {
		...
		/*
		 List 계열의 컬렉션을 생성한다. 이때 타입 매개변수는 board 테이블을
	...
	public BoardDTO selectView(String num) {
		...
		/* 내부조인(inner join)을 통해 member 테이블의 name 컬럼까지
		 SELECT 한다. */
		...
		try {
			...
			if(rs.next()) {
				...
				둘다 사용할 수 있다. 날짜인 경우에는 getDate()로 인출할 수 있다. */
